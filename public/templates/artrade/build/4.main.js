...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__daybid__ = __webpack_require__(321);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DaybidPageModule", function() { return DaybidPageModule; });
...
var DaybidPageModule = (function () {
    function DaybidPageModule() {
    }
    return DaybidPageModule;
}());
DaybidPageModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["a" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__daybid__["a" /* DaybidPage */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__daybid__["a" /* DaybidPage */]),
        ],
        exports: [
            __WEBPACK_IMPORTED_MODULE_2__daybid__["a" /* DaybidPage */]
        ]
...
//# sourceMappingURL=daybid.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(101);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__service_item__ = __webpack_require__(305);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DaybidPage; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/**
 * Generated class for the Daybid page.
 *
 * See http://ionicframework.com/docs/components/#navigation for more info
 * on Ionic pages and navigation.
 */
var DaybidPage = (function () {
    function DaybidPage(navCtrl, navParams, itemService, toaCtrl) {
    ...
    DaybidPage.prototype.ionViewDidLoad = function () {
        this.segment = 'today';
    };
    DaybidPage.prototype.ngOnInit = function () {
        this.getTodayItem();
    };
    DaybidPage.prototype.enterItem = function (item) {
        this.navCtrl.push('ItemPage', { item: item });
    };
    DaybidPage.prototype.enterMessagePage = function () {
        this.navCtrl.push('MessagePage');
    };
    DaybidPage.prototype.getTodayItem = function () {
        var _this = this;
        this.itemService.getTodayItemList(this.today_pnum, this.today_pqty).subscribe(function (itemList) {
            _this.today_pnum++;
            _this.todayItemList = itemList;
        });
    };
    DaybidPage.prototype.getMoreTodayItem = function (infiniteScroll) {
        var _this = this;
        this.itemService.getTodayItemList(this.today_pnum, this.today_pqty).subscribe(function (itemList) {
            if (itemList.length > 0) {
                ...
                _this.todayItemList = _this.todayItemList.concat(itemList);
            }
            else {
                if (infiniteScroll) {
                    infiniteScroll.complete();
...
DaybidPage = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicPage */])(),
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_5" /* Component */])({
        selector: 'page-daybid',template:/*ion-inline-start:"/Users/apple/ionic project/artrade/src/pages/daybid/daybid.html"*/'<!--\n  Generated template for the Daybid page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>每日一拍</ion-title>\n    <ion-buttons end>\n      <button ion-button icon-only clear color="light" (click)="enterMessagePage()">\n        <ion-icon large item-left name="text"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n  <ion-toolbar>\n    <ion-segment [(ngModel)]="segment">\n      <ion-segment-button value="today">\n        今天\n      </ion-segment-button>\n      <ion-segment-button value="tomorrow">\n        明天\n      </ion-segment-button>\n      <ion-segment-button value="after-tomorrow">\n        后天\n      </ion-segment-button>\n    </ion-segment>\n  </ion-toolbar>\n</ion-header>\n\n\n<ion-content [hidden]="segment !== \'today\'" fullscreen="true" class="cards-bg">\n  <ion-list>\n    <ion-card *ngFor="let item of todayItemList">\n      <img [src]="item.picPath" />\n      <ion-card-content (click)="enterItem(item)">\n        <div>{{item.title}}</div>\n        <div>起拍价 {{item.currentBid}}元</div>\n        <div>下线时间：{{item.timeEnd}}</div>\n      </ion-card-content>\n    </ion-card>\n  </ion-list>\n  <ion-infinite-scroll (ionInfinite)="getMoreTodayItem($event)" threshold="30%">\n    <ion-infinite-scroll-content>\n    </ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n\n</ion-content>\n<ion-content [hidden]="segment !== \'tomorrow\'" fullscreen="true" class="cards-bg">\n\n</ion-content>\n<ion-content [hidden]="segment !== \'after-tomorrow\'" fullscreen="true" class="cards-bg">\n\n</ion-content>\n'/*ion-inline-end:"/Users/apple/ionic project/artrade/src/pages/daybid/daybid.html"*/,
        providers: [__WEBPACK_IMPORTED_MODULE_2__service_item__["a" /* ItemService */]]
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__service_item__["a" /* ItemService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* ToastController */]])
], DaybidPage);

//# sourceMappingURL=daybid.js.map
