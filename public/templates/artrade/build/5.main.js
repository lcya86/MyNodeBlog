...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__collection__ = __webpack_require__(320);
...
var CollectionPage = (function () {
    function CollectionPage(navCtrl, itemService, navParams, toaCtrl) {
    ...
    CollectionPage.prototype.getCollectionList = function (pnum, pqty) {
        var _this = this;
    ...
    CollectionPage.prototype.getMoreCollection = function (infiniteScroll) {
        var _this = this;
...
CollectionPage = __decorate([
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_5" /* Component */])({
        selector: 'page-collection',template:/*ion-inline-start:"/Users/apple/ionic project/artrade/src/pages/collection/collection.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title style="text-align:center">\n      当日结束\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content fullscreen="true" class="cards-bg">\n  <ion-list>\n    <ion-item>\n      <ion-label>拍品类型</ion-label>\n      <ion-select [(ngModel)]="gaming" cancelText="取消" placeholder="中国书画" okText="确定" interface="action-sheet">\n        <ion-option value="1">中国书画</ion-option>\n        <ion-option value="2">古瓷杂项</ion-option>\n        <ion-option value="3">当代工艺</ion-option>\n        <ion-option value="4">油画雕塑</ion-option>\n      </ion-select>\n    </ion-item>\n  </ion-list>\n  <ion-list>\n    <div *ngFor="let item of items" class="lot_item">\n      <div class="img">\n        <img src="https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=1794894692,1423685501&fm=117&gp=0.jpg"/>\n        <div class="status">{{item.status}}</div>\n      </div>\n      <div class="detail">\n        <div>{{item.name}}</div>\n        <div class="time">结束时间：{{item.end_time}}</div>\n        <div>起拍价：<span style="color:#686868">{{item.start}}</span></div>\n        <div>当前价：<span style="color:#686868">{{item.now}}</span></div>\n        <div><span style="color:#686868"><ion-icon ios="ios-eye" md="md-eye"></ion-icon></span>　{{item.nums}}人围观</div>\n      </div>\n    </div>\n  </ion-list>\n\n  <!-- <ion-infinite-scroll (ionInfinite)="getMoreCollection($event)">\n    <ion-infinite-scroll-content>\n    </ion-infinite-scroll-content>\n  </ion-infinite-scroll> -->\n</ion-content>\n\n<!-- <ion-header>\n  <ion-navbar>\n    <ion-title>\n      收藏\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content fullscreen="true" class="cards-bg">\n  <ion-list>\n    <h5 text-center *ngIf="collectionList.length === 0" style="color:rgb(150, 150, 150);margin-top:60%;">\n      还没有藏品，赶快去收藏吧(*^__^*)\n    </h5>\n    <ion-card *ngFor="let item of collectionList">\n      <div [ngStyle]="{\'background-image\':\'url(\'+item.picPath+\')\'}" style="height:150px;background-size:cover;">\n      </div>\n      <ion-card-content>\n        <ion-card-title>\n          {{item.title}}\n        </ion-card-title>\n        <p>当前价: ￥{{item.currentBid}}</p>\n      </ion-card-content>\n      <ion-row no-padding>\n        <ion-col text-left>\n          <button small ion-button clear icon-left>\n            <ion-icon name="clock"></ion-icon>一天后结束\n          </button>\n        </ion-col>\n        <ion-col text-right>\n          <button small ion-button clear icon-left>\n            <ion-icon name="eye"></ion-icon>435\n          </button>\n        </ion-col>\n      </ion-row>\n    </ion-card>\n  </ion-list>\n  <ion-infinite-scroll (ionInfinite)="getMoreCollection($event)">\n    <ion-infinite-scroll-content>\n    </ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n</ion-content> -->\n'/*ion-inline-end:"/Users/apple/ionic project/artrade/src/pages/collection/collection.html"*/,
        providers: [__WEBPACK_IMPORTED_MODULE_2__service_item__["a" /* ItemService */]]
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__service_item__["a" /* ItemService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* ToastController */]])
], CollectionPage);
